...
int main( int argc, char ** argv ) {
	...
	for( ; n != 1; ++index ) {
		...
		int curr_max_cofactor = 0;
                ...
                if (sm_fac[2] == 1 && sm_fac[3] == 1)           { driver = "Driver: 2 * 3";              found_driver = true; }
                ...
                else if (sm_fac[2] == 3 && sm_fac[5] == 1)      { driver = "Guide: 2^3 * 5"; }
                else if (sm_fac[2] == 3 && sm_fac[7] == 1)      { driver = "Guide: 2^3 * 7"; }
                else if (sm_fac[2] == 3 && sm_fac[3] != 0)      { driver = "Guide: 2^3 with 3"; }
                else if (sm_fac[2] == 5 && sm_fac[3] == 1)      { driver = "Guide: 2^5 * 3"; }
                else if (sm_fac[2] == 1 && sm_fac[3] == 0)      { driver = "Downdriver!";                found_driver = false; }
                else if (sm_fac[3] == 0)                        { driver = "No 3";                       found_driver = false; }
                else if (sm_fac[2] >= 8)                        { driver = "Large power of 2";           found_driver = false; }
